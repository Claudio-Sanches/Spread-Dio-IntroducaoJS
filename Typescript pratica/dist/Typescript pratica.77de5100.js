...
"use strict"; // Função Soma com typescript informando insconsistências quando aplicado String no chamado
...
var input = document.getElementById('input'); // exemplo para validar a função
...
;
adicionaApendiceALista([1, 2, 3], 1); // na função está se trando apenas String´s, substituindo o valor em toda a string

function adicionaApendiceAListaTexto(array, valor) {
...
function redirecioneOpcional(usuario) {
  if ('cargo' in usuario) {// redirecionar para área de administração;
  } // redirecionar para área dO usuário;
...
var meuCachorroClass =
/** @class */
function () {
  function meuCachorroClass(nome, idade) {
    this.nome = nome;
    this.idade = idade;
  }

  return meuCachorroClass;
}();

var cao = new meuCachorroClass('Apolo', 14);
cao.idade = 8;
console.log(cao); // Importação de bibliotecas....
...
//# sourceMappingURL=/Typescript%20pratica.77de5100.js.map